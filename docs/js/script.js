...
/* harmony import */ var _modules_multiselect__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/multiselect */ "./#src/js/modules/multiselect.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var Event = function Event(id, name, participants, date) {
  ...
  var Meeting = /*#__PURE__*/function () {
    function Meeting(id, name, participants) {
    ...
    _createClass(Meeting, [{
      ...
      value: function render() {
        getEvent();
        var parentCell = document.querySelector("#".concat(this.id));
        var eventContainer = document.createElement('div');
        eventContainer.classList.add('meeting');
        eventContainer.innerHTML = "\n\t\t\t\t\t<div class=\"".concat(this.id, "\" data-close>&times;</div>\n\t\t\t\t\t<p class=\"").concat(this.id + 'goal', "\">").concat(this.name, "</p>\n\t\t\t\t");
        parentCell.append(eventContainer);
        console.log('works');
        closeTrigger = document.querySelectorAll('[data-close]');
        closeTrigger.forEach(function (item) {
  ...
  function pushEventName(selector) {
    var transformedSelector = selector + 'goal';
    var meetingGoal = document.querySelector(".".concat(transformedSelector));
    modalHeader.innerHTML = "\n\t\t\t<div class=\"modal__header\">\n\t\t\t\t<h3>Are you sure? You want to delete this meeting ( ".concat(meetingGoal.innerHTML, " )</h3>\n\t\t\t</div>\t\n\t\t");
  }
  ...
  if (window.location.pathname === '/calendar/' || window.location.pathname.indexOf('index.html') > -1) {
    ...
    Object(_modules_multiselect__WEBPACK_IMPORTED_MODULE_8__["default"])();
    renderAll();
  ...
  if (window.location.pathname.indexOf('create-event.html') > -1) {
    ...
    var eventName = document.querySelector('.event__goal'),
        ...
        closeModal = document.querySelector('.modal__close'); // validation for inputs
    ...
    eventName.addEventListener('input', function (e) {
      if (e.target.value !== '') {
    ...
    document.querySelector('.multi-select-component').addEventListener('click', function (e) {
      if (e.target.value !== '') {
    ...
    function createEventData(e) {
      e.preventDefault();
      var eventId = eventDay.value + eventTime.value;
      checkInputs(eventName, validationName);
      checkInputs(_participants, validationMember);
    ...
    eventBtn.addEventListener('click', function (e) {
      return createEventData(e);
    });
  } else {// 404 no such page
  }
});
...
function multiselect() {
  ...
  function init(element) {
    ...
    wrapper.classList.add("multi-select-component"); //console.log(wrapper)
    ...
    input.addEventListener("click", openOptions); //console.log(input)
  ...
  function addPlaceholder(wrapper) {
    ...
    if (!tokens.length && !(document.activeElement === input_search)) input_search.setAttribute("placeholder", "Names");
