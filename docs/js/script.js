...
/* harmony import */ var _modules_multiselect__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/multiselect */ "./#src/js/modules/multiselect.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.location.pathname === '/calendar/' || window.location.pathname.indexOf('index.html') > -1) {
    ...
    Object(_modules_multiselect__WEBPACK_IMPORTED_MODULE_11__["default"])();
    renderAll();
    ...
    filterEvents.addEventListener('click', function () {
      ...
      if (members.length <= 1) {
        ...
        var memArr = transformArr(members);
        cleanCells();
        eventsArr.forEach(function (item) {
